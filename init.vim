...
" Copyright (c) 2016-2021 Nglsg & Contributors
" Author: Nglsg < 927039685@qq.com >
...
if version >= 800
  ...
  set langmenu=zh_CN.UTF-8                                   " 编码
  set fencs=utf-8,ucs-bom,shift-jis,gb18030,gbk,gb2312,cp936
  set termencoding=utf-8 
  set fileencodings=ucs-bom,utf-8,cp936
  set fileencoding=utf-8

endif                                                      " 自动设置项目根目录                                       Plug 'airblade/vim-rooter'
" 自动补全对应的符号
Plug 'jiangmiao/auto-pairs'                                " 注释
